...
struct ByteOrder {
    ...
    virtual void PutUint64(slice<>, uint64) = 0;
...
struct AppendByteOrder {
    virtual slice<> AppendUint16(slice<>, uint16) = 0;
    virtual slice<> AppendUint32(slice<>, uint32) = 0;
    virtual slice<> AppendUint64(slice<>, uint64) = 0;
...
struct littleEndian : public ByteOrder, public AppendByteOrder {
    ...
    virtual slice<> AppendUint16(slice<> b, uint16 v) override { return append(b, byte(v), byte(v >> 8)); }
    ...
    virtual slice<> AppendUint32(slice<> b, uint32 v) override {
    ...
    virtual void PutUint64(slice<> b, uint64 v) override {
        b[0] = byte(v);
        b[1] = byte(v >> 8);
        b[2] = byte(v >> 16);
        b[3] = byte(v >> 24);
    ...
    virtual slice<> AppendUint64(slice<> b, uint64 v) override {
...
struct bigEndian : public ByteOrder, public AppendByteOrder {
    ...
    virtual slice<> AppendUint16(slice<> b, uint16 v) override { return append(b, byte(v >> 8), byte(v)); }
