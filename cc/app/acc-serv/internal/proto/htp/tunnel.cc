...
*/
static R<int /*off*/, string /*addr*/, error> parseRequest(bytez<> hdr) {
    static bytez<> CRLF1("\r\n");
    static bytez<> CRLF2("\r\n\r\n");
...
error handleTunnel(net::Conn c, bytez<> hdr) {
    ...
    if (er1) {
        ...
        static const bytez<> FAIL("HTTP/1.1 500\r\n\r\n");
        c->Write(FAIL);
        return er1;
    }
    DEFER(rc->Close());
    ...
    // reply 200 OK
    static const bytez<> OK("HTTP/1.1 200 Connection Established\r\n\r\n");
